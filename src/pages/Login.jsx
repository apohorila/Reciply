      ...
      <div className="mx-auto flex w-fit flex-col items-center space-y-5 rounded-4xl border bg-[#F85E00] px-10 py-15 font-[Stolzl] text-white">
        ...
        <div className="text-center">
          ...
          <p className="text-2xl">
            Sign in to acces your favorites and meal plan
          </p>
        </div>
        <form className="flex flex-col py-4" onSubmit={handleSubmit}>
          ...
          />
          <p className="text-red-600 mx-auto mt-4">{error? error : ""}</p>
          <input
            type="submit"
            value="Sign In"
        ...
        <button className="cursor-pointer rounded-full border-0 bg-white p-2" onClick={handleGoogleLogin}>
          <svg
